...
<head>
    ...
    <title>تسجيل الدخول حساب إداري - بوابة مدينة قليبية </title>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class=""><a href=""><span class="brand-name">تسجيل الدخول</span></a> باستعمال حساب إداري </h1>
                        <p class="signup-link">ليس لديك حساب ؟ <a href="auth_register.php">إنشاء حساب</a></p>
                        <form class="text-left" method="POST" action="functions/loginAdmin.php">
                            <div class="form">
                                <?php
                                    if (isset($_GET['Error'])) {
                                        echo '
                                ...
                                <br>
                                <div>
                                    <a href="auth_login.php" class="btn btn-info" style="text-align: center;width: 100%;"> الدخول باستعمال حساب عادي</a>
                                </div>
                            </div>
                        </form>                        
